...
class Distribution(nn.Module):
    ...
    def entropy_per_dim(self) -> torch.Tensor:
        """Return entropy without reducing independent output dimensions."""
        raise NotImplementedError
    ...
    def log_prob_per_dim(self, outputs: torch.Tensor) -> torch.Tensor:
        """Return log-probability without reducing independent output dimensions."""
        raise NotImplementedError
...
class GaussianDistribution(Distribution):
    ...
    def entropy(self) -> torch.Tensor:
        ...
        return self.entropy_per_dim.sum(dim=-1)

    @property
    def entropy_per_dim(self) -> torch.Tensor:
        """Return one entropy value per independent Gaussian output."""
    ...
    def log_prob(self, outputs: torch.Tensor) -> torch.Tensor:
        ...
        return self.log_prob_per_dim(outputs).sum(dim=-1)

    def log_prob_per_dim(self, outputs: torch.Tensor) -> torch.Tensor:
        """Compute one log-probability value per independent Gaussian output."""
